...
public class position_change_task : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        change_cube_position1(cube1_position, cube2_position);
        change_cube_position2(cube2_position, cube3_position);
        change_cube_position3(cube3_position, cube1_position);



    }

    void change_cube_position1(Vector3 cube1_position, Vector3 cube2_position)
    {
    ...
    void change_cube_position2(Vector3 cube2_position, Vector3 cube3_position)
    {
        cube2_position.x = cube3_position.x;
        cube2_position.y = cube3_position.y;
        cube2_position.z = cube3_position.z;

        Debug.Log("Position after change" + cube2_position);

        cube_object2.transform.Translate(new Vector3(cube2_position.x, cube2_position.y, cube2_position.z));

    }

    void change_cube_position3(Vector3 cube3_position, Vector3 cube1_position)
    {
        cube3_position.x = cube1_position.x;
        cube3_position.y = cube1_position.y;
        cube3_position.z = cube1_position.z;

        Debug.Log("Position after change" + cube3_position);

        cube_object1.transform.Translate(new Vector3(cube3_position.x, cube3_position.y, cube3_position.z));
